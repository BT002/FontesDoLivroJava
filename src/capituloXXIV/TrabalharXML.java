...
public class TrabalharXML {
	 ...
	 * declaração throws que indica que podem ocorrer essas exceções
	 * (JDOMException e IOCException), A responsabilidade de tratá-las
	 * fica para a classe e o método que o chamar.
	 */
	...
	public static void lerXML() throws JDOMException, IOException {
		 ...
		 * lerão do arquivo XML (raiz e elementos) e o Iterator que os
		 * percorrerá
		 */
	...
	public static void escreverXML() throws IOException{
		 ...
		 * é criado um elemento contato para o XML e pupulado
		 * com seu atributo (id --> Autonumérico) mais o nome e email.
		 */
