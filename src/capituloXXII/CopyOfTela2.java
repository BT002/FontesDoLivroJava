...
public class CopyOfTela2 extends JFrame implements ActionListener {
	...
	public CopyOfTela2(String titulo) {
		super(titulo);
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == btnSalvar) { /* no caso de haver clicado em Salvar: */
